-- Migration: Fix credit_transactions constraint violations
-- Description: Updates all credit functions to work with credit_transactions table structure
-- NOTE: This migration is superseded by schema/22-remove-redundant-credit-transactions-columns.sql
-- which removes the redundant type and amount columns entirely.
-- Date: 2025-12-07

-- ========================================
-- PART 1: Fix deduct_user_credits function
-- ========================================
...
-- ========================================
-- PART 2: Fix add_user_credits function (with SECURITY DEFINER)
-- ========================================
...
-- ========================================
-- PART 3: Fix add_user_credits function (alternative signature from schema/06-functions.sql)
-- ========================================
...
-- ========================================
-- PART 4: Fix deduct_user_credits function (simpler version from schema/06-functions.sql)
-- ========================================

-- Note: This function signature is the same as PART 1, but with simpler logic
-- The CREATE OR REPLACE in PART 1 will handle this, but keeping for reference
-- If you have a simpler version without cycle tracking, you can use this:
...
-- Summary
-- ========================================
-- NOTE: This migration has been updated to remove references to redundant columns.
-- Please use schema/22-remove-redundant-credit-transactions-columns.sql instead,
-- which properly removes the 'type' and 'amount' columns from the table.
--
-- This migration is idempotent - safe to run multiple times
-- All CREATE OR REPLACE statements ensure no errors on re-run
